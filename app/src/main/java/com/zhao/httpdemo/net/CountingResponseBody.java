...
public class CountingResponseBody extends ResponseBody {
    ...
    public CountingResponseBody(ResponseBody responseBody,
                                Listener listener) {
    ...
    public static interface Listener {
        ...
        public void onResponseProgress(long bytesWritten, long contentLength, Boolean isDone);
    }
}
